...
class Student extends User{
    function addStudent($fiN, $sN, $tN, $fN, $nN, $bD, $g){
    ...
    private function insertDataIntoDataBase(){
        ...
        VALUES
        ('$firstName', '$secondName', '$thirdName', '$forthName', '$email', '$pass', '$nN', '$bD', '$g', '1')");
        }
        public function removeStudentFromSchool($nationalNumber){
            include "dB.php";
